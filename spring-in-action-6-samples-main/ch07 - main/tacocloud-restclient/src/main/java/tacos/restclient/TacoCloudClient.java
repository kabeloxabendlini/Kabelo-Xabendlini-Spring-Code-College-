...
public class TacoCloudClient {
  ...
  public Ingredient getIngredientById(String ingredientId) {
    return rest.getForObject("http://localhost:8081/data-api/ingredients/{id}",
  ...
  */
  ...
  public Ingredient getIngredientById(String ingredientId) {
    ResponseEntity<Ingredient> responseEntity =
        rest.getForEntity("http://localhost:8081/ingredients/{id}",
            Ingredient.class, ingredientId);
  ...
  */
  ...
  public List<Ingredient> getAllIngredients() {
    return rest.exchange("http://localhost:8081/api/ingredients",
  ...
  public void updateIngredient(Ingredient ingredient) {
    rest.put("http://localhost:8081/data-api/ingredients/{id}",
  ...
  public Ingredient createIngredient(Ingredient ingredient) {
    return rest.postForObject("http://localhost:8081/data-api/ingredients",
  ...
  public java.net.URI createIngredient(Ingredient ingredient) {
    return rest.postForLocation("http://localhost:8081/ingredients",
        ingredient);
  }
  */
  ...
  public Ingredient createIngredient(Ingredient ingredient) {
    ResponseEntity<Ingredient> responseEntity =
           rest.postForEntity("http://localhost:8081/ingredients",
                              ingredient,
                              Ingredient.class);
  ...
  */
  ...
  public void deleteIngredient(Ingredient ingredient) {
    rest.delete("http://localhost:8081/data-api/ingredients/{id}",
        ingredient.getId());
  }
